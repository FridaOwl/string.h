...
START_TEST(simple_int) {
  ...
  int val = 69;
  ck_assert_int_eq(d3_sprintf(str1, format, val), sprintf(str2, format, val));
...
START_TEST(star_width_int) {
  ...
  char *format = "%0*d";
  int val = 69;
  ck_assert_int_eq(d3_sprintf(str1, format, 5, val),
...
START_TEST(many_flags_many_ints) {
  ...
  int val = 69;
  ck_assert_int_eq(
      d3_sprintf(str1, format, 5, val, -10431, 13, 5311, 0, -581813581),
...
START_TEST(unsigned_val_many) {
  ...
  unsigned long int val = 949149114140;
  ck_assert_int_eq(
      d3_sprintf(str1, format, val, 14, 1441, 14414, 9681),
...
START_TEST(octal_zero) {
  ...
  char *format = "%o";
  ck_assert_int_eq(d3_sprintf(str1, format, 0), sprintf(str2, format, 0));
...
START_TEST(unsigned_zero) {
  ...
  char *format = "%u";
  ck_assert_int_eq(d3_sprintf(str1, format, 0),
...
START_TEST(hex_many) {
  ...
  unsigned val = 858158158;
  ck_assert_int_eq(d3_sprintf(str1, format, val, val, val, val, val, val),
...
START_TEST(one_many) {
  ...
  char val = 'c';
  ck_assert_int_eq(d3_sprintf(str1, format, val, 'c', 'a', 'b', 'b'),
...
START_TEST(string_many) {
  ...
  ck_assert_int_eq(d3_sprintf(str1, format, val, s1, s2, s3),
...
START_TEST(ptr) {
  ...
  char *format = "%p";
  ck_assert_int_eq(d3_sprintf(str1, format, format),
...
START_TEST(null_ptr) {
  ...
  char *format = "%p";
  char *ptr = NULL;
  ck_assert_int_eq(d3_sprintf(str1, format, ptr), sprintf(str2, format, ptr));
...
START_TEST(n_specifier) {
  ...
  ck_assert_int_eq(d3_sprintf(str1, format, &ret), sprintf(str2, format, &ret));
...
START_TEST(float_many) {
  ...
  ck_assert_int_eq(d3_sprintf(str1, format, val, val1, val2, val3, val4, val5),
...
START_TEST(all_empty) {
  char str1[BUFF_SIZE];
  char str2[BUFF_SIZE];
  ck_assert_int_eq(d3_sprintf(str1, "abc"), sprintf(str2, "abc"));
...
START_TEST(test_one_char) {
  ...
  ck_assert_int_eq(d3_sprintf(str1, "%c", '\t'), sprintf(str2, "%c", '\t'));
...
START_TEST(test_many_char) {
  ...
  ck_assert_int_eq(d3_sprintf(str1, "%c%c%c%c%c", '\t', '\n', '0', 'S', 's'),
...
START_TEST(test_one_string) {
  ...
  ck_assert_int_eq(d3_sprintf(str1, "%s", "Drop Sega PLS"),
...
START_TEST(test_many_string) {
  ...
  ck_assert_int_eq(
      d3_sprintf(str1, "%s%s%s%s%s", "Drop", " ", "Sega", " ", "PLS"),
...
START_TEST(test_one_dec) {
  ...
  ck_assert_int_eq(d3_sprintf(str1, "%d", 666), sprintf(str2, "%d", 666));
...
START_TEST(test_many_dec) {
  ...
  ck_assert_int_eq(d3_sprintf(str1, "%d%d%d%d", -999, 0, 666, -100),
...
START_TEST(test_one_int) {
  ...
  ck_assert_int_eq(d3_sprintf(str1, "%i", -0), sprintf(str2, "%i", -0));
...
START_TEST(test_many_int) {
  ...
  ck_assert_int_eq(d3_sprintf(str1, "%i%i%i%i", -999, 0, 666, -100),
...
START_TEST(test_one_float) {
  ...
  ck_assert_int_eq(d3_sprintf(str1, "%f", 0.0001), sprintf(str2, "%f", 0.0001));
...
START_TEST(test_many_float) {
  ...
  ck_assert_int_eq(
      d3_sprintf(str1, "%f%f%f%f", -999.666, 0.0001, 666.999, -100.001),
...
START_TEST(test_one_unsigned_dec) {
  ...
  ck_assert_int_eq(d3_sprintf(str1, "%u", 100),
...
START_TEST(test_many_unsigned_dec) {
  ...
  ck_assert_int_eq(d3_sprintf(str1, "%u%u%u%u", 999, 0, 666, 100),
...
START_TEST(test_one_char_with_alignment_left) {
  ...
  ck_assert_int_eq(d3_sprintf(str1, "%8c", '\t'), sprintf(str2, "%8c", '\t'));
...
START_TEST(test_many_char_with_alignment) {
  ...
  ck_assert_int_eq(
      d3_sprintf(str1, "%3c%-11c%10c%-2c%c", '\t', '\n', '0', 'S', 's'),
...
START_TEST(test_one_hex_lower) {
  char str1[BUFF_SIZE];
  char str2[BUFF_SIZE];
  ck_assert_int_eq(d3_sprintf(str1, "%x", (unsigned)INT32_MIN),
                   sprintf(str2, "%x", (unsigned)INT32_MIN));
  ck_assert_str_eq(str1, str2);
  ck_assert_int_eq(d3_sprintf(str1, "%x", 0), sprintf(str2, "%x", 0));
  ck_assert_str_eq(str1, str2);
  ck_assert_int_eq(d3_sprintf(str1, "%x", INT32_MAX),
...
START_TEST(test_many_hex_lower) {
  ...
  ck_assert_int_eq(
      d3_sprintf(str1, "%x%x%x%x%x", 12340987, 135, 0, -1230, -123213123),
...
START_TEST(test_one_hex_lower_with_alignment_left) {
  ...
  ck_assert_int_eq(d3_sprintf(str1, "%-3x", (unsigned)INT32_MIN),
                   sprintf(str2, "%-3x", (unsigned)INT32_MIN));
  ck_assert_str_eq(str1, str2);
  ck_assert_int_eq(d3_sprintf(str1, "%-3x", 0), sprintf(str2, "%-3x", 0));
  ck_assert_str_eq(str1, str2);
  ck_assert_int_eq(d3_sprintf(str1, "%-3x", INT32_MAX),
...
START_TEST(test_one_hex_lower_with_alignment_right) {
  ...
  ck_assert_int_eq(d3_sprintf(str1, "%13x", (unsigned)INT32_MIN),
                   sprintf(str2, "%13x", (unsigned)INT32_MIN));
  ck_assert_str_eq(str1, str2);
  ck_assert_int_eq(d3_sprintf(str1, "%13x", 0), sprintf(str2, "%13x", 0));
  ck_assert_str_eq(str1, str2);
  ck_assert_int_eq(d3_sprintf(str1, "%13x", INT32_MAX),
...
START_TEST(test_one_hex_upper_with_alignment_left) {
  ...
  ck_assert_int_eq(d3_sprintf(str1, "%-60X", INT32_MIN),
                   sprintf(str2, "%-60X", (unsigned)INT32_MIN));
  ck_assert_str_eq(str1, str2);
  ck_assert_int_eq(d3_sprintf(str1, "%-60X", 0), sprintf(str2, "%-60X", 0));
  ck_assert_str_eq(str1, str2);
  ck_assert_int_eq(d3_sprintf(str1, "%-60X", INT32_MAX),
...
START_TEST(test_one_hex_upper_with_alignment_right) {
  ...
  ck_assert_int_eq(d3_sprintf(str1, "%7X", (unsigned)INT32_MIN),
                   sprintf(str2, "%7X", (unsigned)INT32_MIN));
  ck_assert_str_eq(str1, str2);
  ck_assert_int_eq(d3_sprintf(str1, "%7X", 0), sprintf(str2, "%7X", 0));
  ck_assert_str_eq(str1, str2);
  ck_assert_int_eq(d3_sprintf(str1, "%7X", INT32_MAX),
...
START_TEST(test_many_hex_lower_with_alignment) {
  ...
  ck_assert_int_eq(
      d3_sprintf(str1, "%2x%-7x%9x%11x%0x", 12340987, 100, 0, 1, -666999),
...
START_TEST(test_one_hex_with_hashtag) {
  ...
  ck_assert_int_eq(d3_sprintf(str1, "%#x", INT32_MIN),
                   sprintf(str2, "%#x", (unsigned)INT32_MIN));
  ck_assert_str_eq(str1, str2);
  ck_assert_int_eq(d3_sprintf(str1, "%#x", 0), sprintf(str2, "%#x", 0));
  ck_assert_str_eq(str1, str2);
...
START_TEST(test_many_hex_lower_with_hashtag_and_alignm) {
  ...
  ck_assert_int_eq(
      d3_sprintf(str1, "%#x%#x%3x%#32x%#-1x", 87, 1222224535, -13, -0,
                 123213123),
...
START_TEST(test_one_hex_lower_with_width_star) {
  ...
  ck_assert_int_eq(d3_sprintf(str1, "%*x", 11, INT32_MIN),
                   sprintf(str2, "%*x", 11, (unsigned)INT32_MIN));
  ck_assert_str_eq(str1, str2);

  ck_assert_int_eq(d3_sprintf(str1, "%*x", 11, 0), sprintf(str2, "%*x", 11, 0));
  ck_assert_str_eq(str1, str2);

  ck_assert_int_eq(d3_sprintf(str1, "%*x", 11, INT32_MAX),
...
START_TEST(test_many_hex_lower_with_width_star_and_align_and_hashtag) {
  ...
  ck_assert_int_eq(d3_sprintf(str1, "%#*x%*x%-12x%3x%*x", 9, 127312897, 0, -1,
                              199, -123978, 3, -1251),
...
START_TEST(test_one_hex_upper_with_precision) {
  ...
  int a = d3_sprintf(str1, "%*.6X", 11, INT32_MIN);
...
START_TEST(test_many_hex_upper_with_precision_and_other) {
  ...
  ck_assert_int_eq(
      d3_sprintf(str1, "%#3.*X%#3x%-7.*X%#-1.8X%4.3X%#2.15x%*.*X%*.1X%3X%-1X",
                 3, -126714, 4444444, 0, 6423235, 0, 666, 999, 13, 5, -419, 9,
                 41, -41, 33),
...
START_TEST(test_one_hex_lower_with_length) {
  ...
  ck_assert_int_eq(d3_sprintf(str1, "%hx", -11),
                   sprintf(str2, "%hx", (unsigned short)-11));
  ck_assert_str_eq(str1, str2);
  ck_assert_int_eq(d3_sprintf(str1, "%hx", 0),
  ...
  ck_assert_int_eq(d3_sprintf(str1, "%lx", val), sprintf(str2, "%lx", val));
  ck_assert_str_eq(str1, str2);
  long unsigned int v = 0;
  ck_assert_int_eq(d3_sprintf(str1, "%lx", v), sprintf(str2, "%lx", v));
  ck_assert_str_eq(str1, str2);
}
END_TEST
...
START_TEST(test_sprintf1) {
  ...
  ck_assert_int_eq(d3_sprintf(str1, format, 1), sprintf(str2, format, 1));
...
START_TEST(test_sprintf2) {
  ...
  ck_assert_int_eq(d3_sprintf(str1, format, 1.1), sprintf(str2, format, 1.1));
...
START_TEST(test_sprintf3) {
  ...
  ck_assert_int_eq(d3_sprintf(str1, format, 'a'), sprintf(str2, format, 'a'));
...
START_TEST(test_sprintf4) {
  ...
  int val = 10000;
  int a = d3_sprintf(str1, format, val);
...
START_TEST(test_sprintf6) {
  ...
  ck_assert_int_eq(d3_sprintf(str1, format, 11.123456),
...
START_TEST(test_sprintf7) {
  ...
  ck_assert_int_eq(d3_sprintf(str1, format, "aboba floppa"),
...
START_TEST(test_sprintf8) {
  ...
  ck_assert_int_eq(d3_sprintf(str1, format, 12341151),
...
START_TEST(test_sprintf9) {
  ...
  ck_assert_int_eq(d3_sprintf(str1, format, 666666666666, 777, 111),
...
START_TEST(test_sprintf10) {
  ...
  ck_assert_int_eq(d3_sprintf(str1, format, 666, -777, 111),
...
START_TEST(test_sprintf11) {
  ...
  ck_assert_int_eq(d3_sprintf(str1, format, -123, 321, -5555, -1213.123),
...
START_TEST(test_sprintf12) {
  ...
  ck_assert_int_eq(
      d3_sprintf(str1, format, 66666666666, 5555555555, 44444444444, k),
...
START_TEST(test_sprintf14) {
  ...
  ck_assert_int_eq(d3_sprintf(str1, format, 1, 222, 33333333333, -166513.1232),
...
START_TEST(test_sprintf17) {
  ...
  ck_assert_int_eq(d3_sprintf(str1, format, "aboba likes floppa"),
...
START_TEST(test_sprintf18) {
  ...
  ck_assert_int_eq(d3_sprintf(str1, format, "", 'f'),
...
START_TEST(test_sprintf19) {
  ...
  ck_assert_int_eq(d3_sprintf(str1, format, "AHHAHAHA\0AHHAHAHAH"),
...
START_TEST(test_sprintf20) {
  ...
  ck_assert_int_eq(d3_sprintf(str1, format, "Nick her"),
...
START_TEST(test_sprintf24) {
  ...
  ck_assert_int_eq(
      d3_sprintf(str1, format, 'f', 21, 42, 666.666,
...
START_TEST(test_sprintf25) {
  ...
  ck_assert_int_eq(d3_sprintf(str1, format, 121.123),
...
START_TEST(test_sprintf28) {
  ...
  int n1;
  int n2;
  int a = d3_sprintf(str1, "%d%n", 123, &n1);
...
START_TEST(test_sprintf29) {
  ...
  ck_assert_int_eq(d3_sprintf(str1, format, 111.111),
...
START_TEST(test_sprintf30) {
  ...
  ck_assert_int_eq(d3_sprintf(str1, format, 111), sprintf(str2, format, 111));
...
START_TEST(test_sprintf31) {
  ...
  char format[] = "%e";
  double x = 111;
  ck_assert_int_eq(d3_sprintf(str1, format, x), sprintf(str2, format, x));
...
START_TEST(test_sprintf32) {
  ...
  ck_assert_int_eq(d3_sprintf(str1, format, 11.111, 222.2222, 666., -555.125),
...
START_TEST(test_sprintf35) {
  ...
  ck_assert_int_eq(d3_sprintf(str1, format, 111.184314818),
...
START_TEST(test_sprintf36) {
  ...
  ck_assert_int_eq(d3_sprintf(str1, format, 0.000111, 111.555, 1.999),
...
START_TEST(test_sprintf37) {
  ...
  ck_assert_int_eq(d3_sprintf(str1, format, 0.666666),
...
START_TEST(test_sprintf38) {
  ...
  ck_assert_int_eq(d3_sprintf(str1, format, 0.0000999, 111.9999, 6.666),
...
START_TEST(test_sprintf39) {
  ...
  ck_assert_int_eq(d3_sprintf(str1, format, 123.123, a, b, c),
...
START_TEST(test_sprintf40) {
  ...
  ck_assert_int_eq(d3_sprintf(str1, format, 123.111, 0.0000999, 0.555),
...
START_TEST(test_sprintf43) {
  ...
  ck_assert_int_eq(d3_sprintf(str1, format, 12345),
...
START_TEST(test_sprintf44) {
  ...
  ck_assert_int_eq(d3_sprintf(str1, format, hex), sprintf(str2, format, hex));
...
START_TEST(g_many) {
  ...
  ck_assert_int_eq(d3_sprintf(str1, format, hex, hex1, hex2, hex3, hex4, hex5),
